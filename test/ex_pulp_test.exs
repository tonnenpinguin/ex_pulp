defmodule ExPulpTest do
  ...
  test "DSL end-to-end: simple minimize" do
    problem = ExPulp.model "simple", :minimize do
      x = var(low: 0, high: 10)
      y = var(low: 0, high: 10)
  ...
  test "DSL end-to-end: maximize" do
    problem = ExPulp.model "maxtest", :maximize do
      x = var(low: 0, high: 10)
  ...
  test "DSL end-to-end: Whiskas diet problem" do
    problem = ExPulp.model "whiskas", :minimize do
  ...
  test "DSL end-to-end: integer knapsack" do
    problem = ExPulp.model "knapsack", :maximize do
  ...
  test "DSL end-to-end: infeasible" do
    problem = ExPulp.model "infeasible", :minimize do
      x = var(low: 0, high: 5)
  ...
  test "value/2 helper" do
    problem = ExPulp.model "val_test", :minimize do
      x = var(low: 0, high: 10)
